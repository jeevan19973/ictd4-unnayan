<%@ Page Title="" Language="C#" MasterPageFile="~/inner_master.master" AutoEventWireup="true" CodeFile="agriculture_rate_other.aspx.cs" Inherits="_Default" %>
                ...
                <td class="auto-style19">
                    <asp:Panel ID="Panel3" runat="server" Height="578px">
                        <div class="auto-style9">
                            &nbsp;&nbsp; &nbsp;&nbsp; <iframe id="I1" name="I1" src="http://karobar.raftaar.in/Business-News/Mandi-Rates" style="width: 969px; height: 566px"></iframe>
                        </div>
                    </asp:Panel>
                    <br />
                </td>
