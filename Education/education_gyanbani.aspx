<%@ Page Title="" Language="C#" MasterPageFile="~/inner_master.master" AutoEventWireup="true" CodeFile="education_gyanbani.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <asp:Panel ID="Panel1" runat="server" Height="217px">
        ...
        <asp:Panel ID="Panel3" runat="server">
            <iframe id="I1" name="I1" src="http://www.ignoukolkatarc.com" style="width: 100%; height: 545px"></iframe>
    </asp:Panel>
    </asp:Content>
