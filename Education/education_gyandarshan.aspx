<%@ Page Title="" Language="C#" MasterPageFile="~/inner_master.master" AutoEventWireup="true" CodeFile="education_gyandarshan.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <asp:Panel ID="Panel1" runat="server" Height="217px">
        ...
        <asp:Panel ID="Panel3" runat="server">
            <iframe src="http://www.ignouonline.ac.in/Broadcast/" style="width: 100%; height: 545px" id="I1" name="I1"></iframe>
    </asp:Panel>
    </asp:Content>
