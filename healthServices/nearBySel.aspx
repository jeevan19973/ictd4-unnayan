<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nearBySel.aspx.cs" Inherits="nearBySel" %>
...
<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="300px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                        <asp:ListItem>bihtaService</asp:ListItem>
                        <asp:ListItem>localCamp</asp:ListItem>
                        <asp:ListItem>adhyayan</asp:ListItem>
                        <asp:ListItem>sevaCenter</asp:ListItem>
                        <asp:ListItem>aara service</asp:ListItem>
                    </asp:DropDownList>
                    <br />
                    <br />
                    <br />
