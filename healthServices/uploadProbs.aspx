<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploadProbs.aspx.cs" Inherits="uploadProbs" %>
...
<body>
    ...
    <div style="margin-left: 50px; margin-top: 20px;">
        ...
        <br />
        <br />
        <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Submit to nearest medical practitioner" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Submit to others" />
