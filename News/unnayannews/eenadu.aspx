<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eenadu.aspx.cs" Inherits="eenadu" %>
...
&nbsp;</div>   
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6" id="middle" >
    <object data=http://www.eenadu.net/  width="100%" height="5000px"> <embed src=http://www.eenadu.net/  width="100%" height="5000px"> </embed></object>
  </div>
