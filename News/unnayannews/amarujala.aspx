<%@ Page Language="C#" AutoEventWireup="true" CodeFile="amarujala.aspx.cs" Inherits="amarujala" %>
...
&nbsp;</div>   
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6" id="middle" >
    <object data=http://www.amarujala.com/ width="100%" height="5000px"> <embed src=http://www.amarujala.com/ width="100%" height="5000px"> </embed></object>
  </div>
