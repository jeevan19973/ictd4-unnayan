<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ndtv.aspx.cs" Inherits="ndtv" %>
...
&nbsp;</div>   
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6" id="middle" >
    <object data=http://www.ndtv.com/ width="100%" height="5000px"> <embed src=http://www.ndtv.com/ width="100%" height="5000px"> </embed></object>
  </div>
