<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hindusthan.aspx.cs" Inherits="hindusthan" %>
...
&nbsp;</div>   
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6" id="middle" >
    <object data=http://www.livehindustan.com/  width="100%" height="5000px"> <embed src=http://www.livehindustan.com/  width="100%" height="5000px"> </embed></object>
  </div>
