<%@ Page Language="C#" AutoEventWireup="true" CodeFile="abpananda.aspx.cs" Inherits="abpananda" %>
...
&nbsp;</div>   
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6" id="middle" >
    <object data=http://abpananda.abplive.in/   width="100%" height="5000px"> <embed src=http://abpananda.abplive.in/   width="100%" height="5000px"> </embed></object>
  </div>
