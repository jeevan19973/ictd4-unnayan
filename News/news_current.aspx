<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_current.aspx.cs" Inherits="news_current" %>
                ...
                <td>
                    <asp:Panel ID="Panel3" runat="server" Height="558px">
                        <div class="auto-style9">
                            <iframe id="I1" name="I1" src="http://bartamanpatrika.com" style="width: 1012px; height: 534px"></iframe>
                        </div>
                    </asp:Panel>
                </td>
            </tr>
